...
async function createEnv(client, credentials, directory) {
	...
	await fchmod(await open(path.join(directory, ".env"), "r+"), 416);
}

//#endregion
export { createEnv as default };