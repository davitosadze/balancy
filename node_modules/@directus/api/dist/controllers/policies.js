...
//#region src/controllers/policies.ts
const router = express.Router();
router.use(use_collection_default("directus_policies"));
...
router.get("/me/globals", async_handler_default(async (req, res, next) => {
	try {
...
var policies_default = router;

//#endregion
export { policies_default as default };