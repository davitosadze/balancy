...
router.post("/:collection", collection_exists_default, async_handler_default(async (req, res, next) => {
	...
	await service.createField(req.params["collection"], field, undefined, { attemptConcurrentIndex: "concurrentIndexCreation" in req.query && req.query["concurrentIndexCreation"] !== "false" });
	try {
