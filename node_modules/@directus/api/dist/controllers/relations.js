...
//#region src/controllers/relations.ts
const router = express.Router();
router.use(use_collection_default("directus_relations"));
...
const newRelationSchema = Joi.object({
	...
	schema: Joi.object({ on_delete: Joi.string().valid("NO ACTION", "SET NULL", "SET DEFAULT", "CASCADE", "RESTRICT") }).unknown().allow(null),
	meta: Joi.any()
});
...
var relations_default = router;

//#endregion
export { relations_default as default };