...
//#region src/services/deployment-projects.ts
var DeploymentProjectsService = class DeploymentProjectsService extends ItemsService {
	constructor(options) {
	...
	*/
	async listWithSync(deploymentId, providerProjects) {
		...
		const toUpdate = selectedProjects.map((dbProject) => {
...
//#endregion
export { DeploymentProjectsService };