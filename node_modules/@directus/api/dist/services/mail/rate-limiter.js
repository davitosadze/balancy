...
//#region src/services/mail/rate-limiter.ts
let emailRateLimiterQueue;
const env = useEnv();
if (toBoolean(env["RATE_LIMITER_EMAIL_ENABLED"]) === true) {
	emailRateLimiterQueue = new RateLimiterQueue(createRateLimiter("RATE_LIMITER_EMAIL"), { maxQueueSize: Number(env["RATE_LIMITER_EMAIL_QUEUE_SIZE"]) });
}
async function useEmailRateLimiterQueue() {
...
//#endregion
export { useEmailRateLimiterQueue };