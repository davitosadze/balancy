...
//#region src/services/graphql/utils/filter-replace-m2a.ts
function filterReplaceM2A(filter_arg, collection, schema, options) {
	...
	for (const key in filter) {
		...
		const type = relation ? getRelationType({
			relation,
			collection,
			field,
			useA2O: true
...
function filterReplaceM2ADeep(deep_arg, collection, schema, options) {
	const deep = deep_arg;
...
//#endregion
export { filterReplaceM2A, filterReplaceM2ADeep };