...
//#region src/services/graphql/types/string-or-float.ts
/**
* Adopted from https://kamranicus.com/handling-multiple-scalar-types-in-graphql/
*/
const GraphQLStringOrFloat = new GraphQLScalarType({
	...
	parseLiteral(ast) {
		switch (ast.kind) {
			...
			default: throw new Error("Value must be either a String or a Float");
		}
	}
});

//#endregion
export { GraphQLStringOrFloat };