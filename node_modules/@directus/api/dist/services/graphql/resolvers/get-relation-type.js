...
//#region src/services/graphql/resolvers/get-relation-type.ts
function getRelationType(schemaComposer, schema, action) {
	const prefix = action === "read" ? "" : "write_";
	const Relation = schemaComposer.createObjectTC({ name: `${prefix}directus_relations` });
