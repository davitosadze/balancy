...
//#region src/services/graphql/resolvers/get-field-type.ts
function getFieldType(schemaComposer, schema, action) {
	const prefix = action === "read" ? "" : "write_";
	const Field = schemaComposer.createObjectTC({ name: `${prefix}directus_fields` });
