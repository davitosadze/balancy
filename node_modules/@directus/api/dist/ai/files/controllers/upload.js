...
const aiFileUploadHandler = async (req, res, next) => {
	...
	try {
		...
		if (!isSupportedProvider(provider)) {
			throw new InvalidPayloadError({ reason: provider === "openai-compatible" ? "File uploads not supported for openai-compatible provider" : `Unsupported provider: ${provider}` });
		}
