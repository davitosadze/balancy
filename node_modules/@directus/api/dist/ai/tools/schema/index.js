		...
		fields.forEach((field) => {
			...
			if (field.meta?.interface) {
				...
				if (field.meta.options?.["choices"]) {
					fieldOverview.interface.choices = field.meta.options["choices"].map((choice) => choice.value);
				}
			}
	...
	for (const field of fields) {
		...
		if (field.meta) {
			...
			if (interfaceConfig) {
				...
				if (options$1?.choices) {
					fieldOverview.interface.choices = options$1.choices;
				}
			}
		}
