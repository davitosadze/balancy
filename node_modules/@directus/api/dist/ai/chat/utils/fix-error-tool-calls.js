	...
	return messages.map((msg) => {
		if (msg["role"] === "assistant" && msg["parts"] && Array.isArray(msg["parts"])) {
			const fixedParts = msg["parts"].map((part) => {
				if (typeof part === "object" && part !== null && "type" in part && typeof part.type === "string" && part.type.startsWith("tool-") && "state" in part && part.state === "output-error" && "rawInput" in part && (!("input" in part) || part.input == null)) {
					return {
						...part,
						input: part.rawInput
					};
