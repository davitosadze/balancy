...
import "../../../../../@vitest_pretty-format@3.2.4/node_modules/@vitest/pretty-format/dist/index.js";
import "../../../../../loupe@3.2.1/node_modules/loupe/lib/index.js";
import { format, getDefaultExportFromCjs, inspect, objDisplay, stringify } from "./chunk-_commonjsHelpers.js";
import { assertTypes, clone, createDefer, createSimpleStackTrace, deepClone, deepMerge, getCallLastIndex, getOwnProperties, getType, isNegativeNaN, isObject, isPrimitive, noop, notNullish, objectAttr, parseRegexp, slash, toArray } from "./helpers.js";
...
function highlight$1(code, options = {
	jsx: false,
	colors: {}
}) {
...
function highlight(code, options = { jsx: false }) {
	return highlight$1(code, {
		jsx: options.jsx,
		colors: getDefs(options.colors || u)
	});
}
