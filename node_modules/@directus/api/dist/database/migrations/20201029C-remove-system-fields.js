...
//#region src/database/migrations/20201029C-remove-system-fields.ts
const defaults = {
	collection: null,
	field: null,
	special: null,
...
const systemFields = [
	...
	},
	{
		...
		field: "note",
		interface: "text-input",
		options: { placeholder: "A description of this collection..." },
		locked: true,
		sort: 4,
		width: "full"
	},
	...
	},
	{
		...
		special: "boolean",
		interface: "toggle",
		options: { label: "Hide within the App" },
		locked: true,
		sort: 6,
		width: "half"
	},
	{
		...
		special: "boolean",
		interface: "toggle",
		options: { label: "Treat as single object" },
		locked: true,
		sort: 7,
		width: "half"
	},
		...
		options: {
			...
			fields: [{
				...
				meta: {
					interface: "text-input",
					width: "half",
					options: { placeholder: "Enter a translation..." }
				}
			}]
		},
		locked: true,
	...
	},
	{
		...
		interface: "toggle",
		special: "boolean",
		options: { label: "Enable App Archive Filter" },
		locked: true,
		sort: 11,
		width: "half"
	},
	...
	},
	{
		...
		field: "name",
		interface: "text-input",
		options: { placeholder: "The unique name for this role..." },
		locked: true,
		sort: 1,
		width: "half"
	},
	...
	},
	{
		...
		field: "description",
		interface: "text-input",
		options: { placeholder: "A description of this role..." },
		locked: true,
		sort: 3,
		width: "full"
	},
	...
	},
	{
		...
		field: "ip_access",
		interface: "tags",
		options: { placeholder: "Add allowed IP addresses, leave empty to allow all..." },
		locked: true,
		special: "csv",
		sort: 6,
		width: "full"
		...
		options: {
			...
			fields: [
				...
				},
				{
					...
					field: "accordion",
					type: "string",
					schema: { default_value: "always_open" },
					meta: {
						width: "half",
						interface: "dropdown",
						options: { choices: [
	...
	},
	{
		...
		sort: 2,
		width: "full",
		options: { placeholder: "An optional description..." }
	},
	{
		collection: "directus_files",
		field: "tags",
	...
	},
	{
		...
		interface: "textarea",
		locked: true,
		options: { placeholder: "A short, public message that supports markdown formatting..." },
		sort: 8,
		width: "full"
	},
	{
	...
	},
	{
		...
		locked: true,
		special: "o2m",
		options: { fields: ["collection", "item"] },
		width: "full"
	},
	{
