...
//#region src/database/migrations/20201029A-remove-system-relations.ts
async function up(knex) {
	await knex("directus_relations").delete().where("many_collection", "like", "directus_%").andWhere("one_collection", "like", "directus_%");
}
