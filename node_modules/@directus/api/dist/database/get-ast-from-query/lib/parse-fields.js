...
async function parseFields(options, context) {
	...
	for (const fieldKey of fields) {
		...
		const isRelational = (!isFunctionCall || isRelationalFunctionCall) && (name.includes(".") || !!context.schema.relations.find((relation) => relation.related_collection === options.parentCollection && relation.meta?.one_field === name));
		if (isRelational) {
