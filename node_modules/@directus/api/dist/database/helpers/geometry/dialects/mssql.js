...
//#region src/database/helpers/geometry/dialects/mssql.ts
var GeometryHelperMSSQL = class extends GeometryHelper {
	isTrue(expression) {
	...
	asText(table, column, alias) {
		if (alias) return this.knex.raw("??.??.STAsText() as ??", [
			table,
			column,
			alias
		]);
