...
async function hasDatabaseConnection(database$1) {
	...
	try {
		if (getDatabaseClient(database$1) === "oracle") {
			await database$1.raw("select 1 from DUAL");
		} else {
			await database$1.raw("SELECT 1");
		}
		return true;
	} catch {
		return false;
...
async function isInstalled() {
	const inspector$1 = getSchemaInspector();
	return await inspector$1.hasTable("directus_collections");
}
