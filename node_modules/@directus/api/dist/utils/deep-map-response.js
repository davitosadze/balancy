...
//#region src/utils/deep-map-response.ts
/**
...
*/
function deepMapResponse(object, callback, context) {
			...
			switch (relationInfo.relationType) {
				...
				case "a2o": {
					...
					if (!related_collection) {
						throw new InvalidQueryError({ reason: `When selecting '${collection.collection}.${field.field}', the field '${collection.collection}.${relationInfo.relation.meta.one_collection_field}' has to be selected when using versioning and m2a relations ` });
					}
					value = deepMapResponse(value, callback, {
						schema: context.schema,
