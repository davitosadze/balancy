...
//#region src/utils/get-column-path.ts
/**
	...
	function followRelation(pathParts, parentCollection = collection, parentFields, addNestedPkField) {
		...
		*/
		...
		if (relationType === "a2o") {
			...
			if (!pathScope) {
				throw new InvalidQueryError({ reason: `You have to provide a collection scope when sorting on a many-to-any item` });
			}
			parent = pathScope;
