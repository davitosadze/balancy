import { DatabaseClients } from "../packages/types/dist/index.js";
...
//#region src/utils/validate-snapshot.ts
const snapshotJoiSchema = Joi.object({
	version: Joi.number().valid(1).required(),
	directus: Joi.string().required(),
	vendor: Joi.string().valid(...DatabaseClients).optional(),
	...
	systemFields: Joi.array().items(Joi.object({
		collection: Joi.string(),
		field: Joi.string(),
		schema: Joi.object({ is_indexed: Joi.bool() })
	})),
