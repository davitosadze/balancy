...
//#region src/utils/sanitize-schema.ts
/**
...
function sanitizeField(field, sanitizeAllSchema = false) {
	...
	const pickedPaths = sanitizeAllSchema ? defaultPaths : [
		...defaultPaths,
		"schema.name",
		"schema.table",
		"schema.data_type",
...
*/
function sanitizeSystemField(field) {
	return pick(field, [
		"collection",
		"field",
		"schema.is_indexed"
...
//#endregion
export { sanitizeCollection, sanitizeColumn, sanitizeField, sanitizeRelation, sanitizeSystemField };