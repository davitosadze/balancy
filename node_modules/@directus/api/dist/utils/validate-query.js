...
//#region src/utils/validate-query.ts
const env = useEnv();
const querySchema = Joi.object({
	...
	limit: "QUERY_LIMIT_MAX" in env && env["QUERY_LIMIT_MAX"] !== -1 ? Joi.number().integer().min(-1).max(env["QUERY_LIMIT_MAX"]) : Joi.number().integer().min(-1),
...
//#endregion
export { validateBoolean, validateGeometry, validateQuery };