...
//#region src/utils/redact-object.ts
/**
...
*/
function redactObject(input, redact, replacement) {
	const wildcardChars = ["*", "**"];
	...
	function traverse(object, checkKeyPaths) {
		...
		const REDACTED_TEXT$1 = replacement();
...
*/
function getReplacer(replacement, values) {
	const filteredValues = values ? Object.entries(values).filter(([_k, v]) => typeof v === "string" && v.length > 0) : [];
	const replacer = (seen$1) => {
			...
			if (value !== null && typeof value === "object") {
				...
				for (const [key2, value2] of Object.entries(value)) {
					if (typeof value2 === "string") {
						...
						newValue[key2] = replacer(seen$1)(key2, value2);
					}
				}
				seen$1.delete(value);
				return newValue;
...
//#endregion
export { getReplacer, redactObject };